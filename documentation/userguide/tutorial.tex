...
In the first section of this tutorial we'll use the following files:
  ...
  \item[\prog{ssu-align-0.1/sa-0p1.params}] A file containing paths to
    ...
    \prog{infernal-1.01/src/} after building \sft{infernal} version
    1.0 with \user{sh ./configure; make;}) and the \prog{esl-sfetch}
    program (which is created in \\ 
    \prog{infernal-1.01/easel/miniapps/}
...
\prog{infernal-1.01/Userguide.pdf}.
...
\user{esl-alimanip -k --mask-rf my2.mask -o my2.masked.archaea.stk seed-15.archaea.noins.stk}
...
\user{esl-ssudraw --mask my2.mask --mask-col seed-15/seed-15.archaea.stk ../seeds/ss-diagrams/archaea-0p1.ps my2.mask.ps}
...
\includegraphics[height=8.5in]{Figures/my2-mask}
