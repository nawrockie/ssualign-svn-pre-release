...
In the first section of this tutorial we'll use the following files:
  ...
  \item[\prog{ssu-align-0.1/sa-0p1.params}] A file containing paths to
    ...
    to run. 
    %You will need to change these paths to point to where
    %you've installed the \prog{cmsearch} and \prog{cmalign} programs
...
\prog{ssu3-0p1.cm} contains three CMs as mentioned above, but you can
...
in the newly created \prog{seed-15/} subdirectory of the current directory.
