...
example, you should be able to run \prog{ssu-align},
...
files created with \prog{esl-alimanip}. The \prog{summarize_mask.pl}
script reports on the number of {0}s and {1}s in a mask. The
\prog{rename_mask.pl} script will copy a mask to a file with a name
that includes the number of {1}s and length of a mask. The
\prog{compare_equiwidth_masks.pl} script will compare and report on
