...
directory and copy \prog{ssu-align-0.1/tutorial/seed-50.fa}, the files
\prog{ssu-align-0.1/seeds/ssu3-0p1.cm},
...
\prog{seed-30-c5/} directory, then execute:

\user{sh seed-30-c5.sh}
