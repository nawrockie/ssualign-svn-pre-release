...
directory and copy \prog{\$SADIR/tutorial/seed-50.fa}, the file
\prog{\$SADIR/tutorial/janelia-sa-0p1.params} and the default parameters file
\prog{\$SADIR/sa-0p1.params} there.
