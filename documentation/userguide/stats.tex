...
aligning, masking and drawing SSU sequences with the \sft{SSU-ALIGN}
...
\sft{greengenes} \cite{DeSantis06a}, \sft{silva}
...
datasets from \sft{silva}, \emph{Silva-Ref} and \emph{Silva-Parc}, were
...
from release 102 of the database. Finally, a single \sft{RDP} dataset
...
subdirectory of \sft{ssu-align}. See the tutorial
