...
The final seed alignments are included in \sft{SSU-ALIGN} package in
...
\prog{ssu-draw} with the following commands from the toplevel
\sft{ssu-align} directory:
...
\caption[Secondary structure diagram displaying the consensus sequence
  ...
  ssu-draw} program included in \sft{ssu-align}.}
\label{fig:arcrf}
\end{figure}
