...
\sft{infernal}'s \prog{cmalign} program is capable of merging
...
\user{../../src/cmalign --merge -o seed-15-coli.bacteria.stk ../seeds/bacteria-0p1.cm ../tutorial/seed-15.bacteria.stk ../tutorial/ecoli.bacteria.stk}
