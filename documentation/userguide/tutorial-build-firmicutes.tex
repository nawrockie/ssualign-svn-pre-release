...
\prog{seeds/bacteria-0p1.fa} through the \sft{RDP-classifier} tool
using default parameters \cite{Wang07} on the \sft{RDP} website: \\
\htmladdnormallink{http://rdp.cme.msu.edu/classifier}{http://rdp.cme.msu.edu/classifier}\footnote{Version
  2.2 of \sft{RDP-classifier} was used with \sft{RDP} training set 6.}
