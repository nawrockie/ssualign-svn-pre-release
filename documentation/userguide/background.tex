...
Each single-stranded consensus position of the model will
...
which is 100\% \prog{A} in the seed alignment would assign high scores
to \prog{A} and low scores to the other three nucleotides. In contrast,
...
pair between positions 1 and 11 100\% \prog{GC} in the seed alignment
and so \prog{GC} pairs in the target would receive high scores, while
