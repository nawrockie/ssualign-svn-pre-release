...
aligners \sft{nast} and \sft{sina}, which generate alignments of a
fixed with (7,682 columns for \sft{nast} and 50,000 for
\sft{sina}). However, to guarantee a fixed width, \sft{nast} must
...
$x$ from datasets B and C. Importantly, \sft{ssu-align} alignments
