...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/bacteria-0p1-dall-wmask}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/archaea-0p1-rf}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/archaea-0p1-info}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/archaea-0p1-struct}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/archaea-0p1-dall}
\end{center}
\caption[Secondary structure diagram displaying frequency of deletions
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/archaea-0p1-ins}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/bacteria-0p1-rf}
\end{center}
\caption[Secondary structure diagram displaying the consensus sequence
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/bacteria-0p1-info}
\end{center}
\caption[Secondary structure diagram displaying primary sequence
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/bacteria-0p1-struct}
\end{center}
\caption[Secondary structure diagram displaying extra information 
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/bacteria-0p1-dall}
\end{center}
\caption[Secondary structure diagram displaying frequency of deletions
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/bacteria-0p1-ins}
\end{center}
\caption[Secondary structure diagram displaying frequency of insertions
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/eukarya-0p1-rf}
\end{center}
\caption[Secondary structure diagram displaying the consensus sequence
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/eukarya-0p1-info}
\end{center}
\caption[Secondary structure diagram displaying primary sequence
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/eukarya-0p1-struct}
\end{center}
\caption[Secondary structure diagram displaying extra information 
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/eukarya-0p1-dall}
\end{center}
\caption[Secondary structure diagram displaying frequency of deletions
...
\begin{figure}
\begin{center}
\includegraphics[width=5.7in]{../../seeds/ss-diagrams/eukarya-0p1-ins}
\end{center}
\caption[Secondary structure diagram displaying frequency of insertions
